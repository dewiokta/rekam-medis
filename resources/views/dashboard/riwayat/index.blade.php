...
@section('container')
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Riwayat Pasien Umum</h1>
      </div>
      <a href="/export-csv-pemeriksaan" target="_blank" class="btn btn-primary me-1">Download Excel</a>
      <a href="/export-pdf-pemeriksaanUmum" target="_blank" class="btn btn-primary me-1">Download PDF</a>
